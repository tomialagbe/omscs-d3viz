...
links =  [
    ...
    links.forEach(function(link) {
        ...
        link.type = link.value === 0 ? "green" : "blue";
    });
    ...
    links.forEach(function(link) {
        ...
        if (linkSource in nodeDegrees) {
            nodeDegrees[linkSource] += 1;
        } else {
            nodeDegrees[linkSource] = 1;
        }

        if (linkTarget in nodeDegrees) {
            nodeDegrees[linkTarget] += 1;
        } else {
            nodeDegrees[linkTarget] = 1;
        }    
    });
    ...
    Object.keys(nodes).forEach(function(key) {            
        nodes[key]['degree'] = nodeDegrees[key];// || {'degree': 0};
    });
    console.log("FINAL");
    console.log(nodes);
